...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'priority' => 'Приоритет',
        'sign' => 'Знак',
        'from' => 'Перенаправлять с',
        'to' => 'Перенаправлять на',
        'vendor_code' => 'Артикул',
        ...
        'category_title_template.*' => 'Шаблон для HTML-тега Title',
        'category_description_template.*' => 'Шаблон для мета-тега Description',
        'product_title_template.*' => 'Шаблон для HTML-тега Title',
        'product_description_template.*' => 'Шаблон для мета-тега Description',
